  ...
  >
    <div class="head flex">
      <div class="people flex">
        <a class="flex trans" target="_blank" href="#"
          ><svg-icon name="user"
        /></a>
        <b>User</b>
      </div>
    ...
    <div class="body flex">
      <div class="content flex">
        <div
          class="flex"
          v-for="lis in appList"
          :class="{ active: activeLis === lis }"
          @mouseenter="activeLis = lis"
        >
      ...
      <div class="detail flex">
        <span
          class="flex"
          v-for="app in activeLis ? activeLis.apps : []"
          @click="startApp(app, $event)"
        >
