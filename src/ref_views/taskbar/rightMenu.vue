    ...
    <div class="body flex">
      ...
      <div v-else-if="show === 'bluetooth'" class="bluetooth">
        <div class="head flex">
          <span
            class="checkbox"
            :class="{ active: blueEnable }"
            @click="blueEnable = !blueEnable"
          ></span>
          <svg-icon name="bluetooth" />
        </div>
        <div class="body flex">
          <a v-if="!blueEnable"> Please Enable Bluetooth! </a>
          <template v-else>
            ...
            <div class="flex">
              ...
              <span>Air Pod</span>
              <i class="flex"
                ><svg-icon name="connect" /><span>Connect</span></i
              >
            </div>
            <div class="flex">
              <svg-icon name="phone" />
      ...
      <div v-else-if="show === 'wifi'" class="wifi">
        <div class="head flex">
          <span
            class="checkbox"
            :class="{ active: wifiEnable }"
            @click="wifiEnable = !wifiEnable"
          ></span>
          <svg-icon name="wifi" />
        </div>
        <div class="body flex">
          <a v-if="!wifiEnable"> Please Enable Wifi! </a>
          <template v-else>
            <div class="flex">
              <svg-icon name="wifi" />
              <span>Home</span>
