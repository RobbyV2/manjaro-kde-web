<template>
  <div class="music">
    <div class="list">
      <div
        v-for="(filepath, idx) in audioFiles"
    ...
    <div class="player flex">
      ...
      <div class="right flex" tabindex="1">
        <svg-icon
          :style="{ fill: volumeActive ? 'rgb(0 208 255)' : 'white' }"
          @click="volumeActive = !volumeActive"
...
export default defineComponent({
  ...
  created() {
    watchEffect(() => {
      const filepath = this.apps.find((app) => app.name === "music").params
        .filepath.value;
      if (filepath) {
